  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto px-6 md:px-12 py-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        >
          Piyasa verisi{" "}
          <span style={{ color: "var(--color-text-2)" }}>Finnhub</span>{" "}
          tarafindan saglanir. Veriler 15 dk gecikmeli olabilir.
          Bu uygulama yatirim tavsiyesi niteligi tasimaz.
        </p>
      ...
      >
        <p className="text-xs text-center" style={{ color: "var(--color-text-3)" }}>
          Veriler yalnizca bilgi amaclidir. Yatirim kararlari icin profesyonel danismanlik aliniz.
        </p>
      </div>
    </footer>
  );
